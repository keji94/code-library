...
public class DateUtil {
     ...
     */
    public static int getSpecialTenMinute() {
        LocalTime localTime = LocalTime.now();
     ...
     * 减天数份
     *
     * @param dayToSubtract 月份
     * @return Date
     */
    public static Date minusDay(long dayToSubtract) {
        LocalDate localDate = LocalDate.now().minusDays(dayToSubtract);
        return localDate2Date(localDate);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getLastMonthFirstDayOfPreviousYear(null));

        System.out.println(getLastMonthLastDayOfPreviousYear(null));

        System.out.println(getHour());

        System.out.println(getSpecialTenMinute());
    }
}
