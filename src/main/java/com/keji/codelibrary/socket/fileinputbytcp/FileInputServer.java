package com.keji.codelibrary.socket.fileinputbytcp;
 ...
 *
 * @author keji
 * @version $Id: FileInputServer.java, v 0.1 2018/3/18 下午2:59 keji Exp $
 */
public class FileInputServer {
     ...
     * 多线程版本的服务端
     */
    public void threadTCP() throws Exception {
        //1,创建服务器，等待客户端连接
